export declare const OrderEventType: {
    ...
    readonly ORDER_SHIPPED: "OrderShipped";
    readonly ORDER_DELIVERED: "OrderDelivered";
    readonly ORDER_CANCELLED: "OrderCancelled";
};
...
export type OrderEvent = OrderPlacedEvent | OrderConfirmedEvent | OrderShippedEvent | OrderDeliveredEvent | OrderCancelledEvent;
